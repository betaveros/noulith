                    ...
                    if c.is_whitespace() {
                        ...
                        if acc == "B" {
                            ...
                            self.emit(match acc.as_str() {
                                ...
                                "__internal_0" => Token::InternalPeekN(0),
                                "__internal_1" => Token::InternalPeekN(1),
                                "__internal_2" => Token::InternalPeekN(2),
                                "__internal_3" => Token::InternalPeekN(3),
                                "__internal_4" => Token::InternalPeekN(4),
                                "__internal_5" => Token::InternalPeekN(5),
                                "__internal_6" => Token::InternalPeekN(6),
                                "__internal_7" => Token::InternalPeekN(7),
                                "__internal_8" => Token::InternalPeekN(8),
                                "__internal_9" => Token::InternalPeekN(9),
                                "__internal_while" => Token::InternalWhile,
                                "__internal_for" => Token::InternalFor,
                                "__internal_call" => Token::InternalCall,
