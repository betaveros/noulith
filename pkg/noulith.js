...
* @returns {any}
*/
__exports.encapsulated_eval = function(code, input, fancy, stateful, js_write, js_display) {
    const ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(input, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.encapsulated_eval(ptr0, len0, ptr1, len1, fancy, stateful, addHeapObject(js_write), addHeapObject(js_display));
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_a4e29c85ba5f6182 = function(arg0, arg1) {
